...
- Память (`C:\Users\sanch\.Codex\projects\C--code-Projects-ms-scaner\memory\`) — там зафиксированы важные архитектурные решения (вариант B для МС, статус деплоя). Перед перепроектированием — заглядывать туда.
